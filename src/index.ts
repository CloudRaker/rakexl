...
export class Rakexl extends Jexl {
  constructor() {
    super();
    // String
    ...
    // FormatDate
    this.addFunction("formatDate", formatDate);
    this.addFunction("$formatDate", formatDate);
    this.addTransform("formatDate", formatDate);
    this.addFunction("dateFormat", formatDate);
    this.addFunction("$dateFormat", formatDate);
    this.addTransform("dateFormat", formatDate);
    // DateTimeAdd
    ...
    // Checksum
    this.addFunction("checksum1", checksum1);
    this.addFunction("$checksum1", checksum1);
    this.addTransform("checksum1", checksum1);
    this.addFunction("checksum2", checksum2);
    this.addFunction("$checksum2", checksum2);
    this.addTransform("checksum2", checksum2);
    this.addFunction("withChecksum", withChecksum);
    this.addFunction("$withChecksum", withChecksum);
    this.addTransform("withChecksum", withChecksum);
    this.addFunction("verifyChecksum", verifyChecksum);
    this.addFunction("$verifyChecksum", verifyChecksum);
    this.addTransform("verifyChecksum", verifyChecksum);
  }
}
