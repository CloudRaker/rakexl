...
export const completionDocs: CompletionDocItem[] = [
  ...
  },
  {
    ...
    "name": "checksum1",
    "label": "checksum1",
    "description": "Computes a 1-character CRC-8 checksum of a string (base-36, uppercase).",
    "detail": "JEXL function",
    "documentation": "Computes a 1-character CRC-8 checksum of a string (base-36, uppercase).\n\n**Examples:**\n`checksum1(\"DOC-001\") // \"H\"`\n`\"CASE-2026-000184\"|checksum1 // \"F\"`\n\n**Parameters:**\n- `input` (unknown): The input string to checksum.\n\n**Returns:** A single uppercase alphanumeric character, or undefined if input is not a string.",
    "examples": [
      "checksum1(\"DOC-001\") // \"H\"",
      "\"CASE-2026-000184\"|checksum1 // \"F\""
    ],
    "parameters": [
      {
        "name": "input",
        "description": "The input string to checksum.",
        "type": "unknown",
        "optional": false
      }
    ],
    "returns": {
      "type": "string",
      "description": "A single uppercase alphanumeric character, or undefined if input is not a string."
    },
    "insertText": "checksum1(${1:input})"
  },
  {
    "type": "function",
    "name": "checksum2",
    "label": "checksum2",
    "description": "Computes a 2-character CRC-8 checksum of a string (base-36, uppercase, zero-padded).",
    "detail": "JEXL function",
    "documentation": "Computes a 2-character CRC-8 checksum of a string (base-36, uppercase, zero-padded).\n\n**Examples:**\n`checksum2(\"DOC-001\") // \"2T\"`\n`\"CASE-2026-000184\"|checksum2 // \"0F\"`\n\n**Parameters:**\n- `input` (unknown): The input string to checksum.\n\n**Returns:** A 2-character uppercase alphanumeric string, or undefined if input is not a string.",
    "examples": [
      "checksum2(\"DOC-001\") // \"2T\"",
      "\"CASE-2026-000184\"|checksum2 // \"0F\""
    ],
    ...
    "returns": {
      "type": "string",
      "description": "A 2-character uppercase alphanumeric string, or undefined if input is not a string."
    },
    "insertText": "checksum2(${1:input})"
  },
  {
    "type": "function",
    "name": "contains",
  ...
  },
  {
    ...
    "parameters": [
      {
        "name": "input",
        "description": "The input date as an ISO string or milliseconds since epoch.",
        "type": "union",
        "optional": false
      },
      {
        "name": "format",
        "description": "The date-fns format string.",
        "type": "string",
        "optional": false
      }
    ],
    "returns": {
      "type": "string",
      "description": "The formatted date string, or null if the input is invalid."
    },
    "insertText": "formatDate(${1:input}, ${2:format})",
    "aliases": [
      "dateFormat"
    ]
  },
  ...
  },
  {
    ...
    "parameters": [
      {
        "name": "input",
        "description": "The string with appended checksum to verify.",
        "type": "unknown",
        "optional": false
      },
      {
        "name": "chars",
        "description": "Number of checksum characters: 1 or 2 (default 2).",
        "type": "unknown",
        "optional": false
      },
      {
        "name": "sep",
        "description": "Separator between the input and checksum (default \"-\").",
        "type": "unknown",
        "optional": false
      }
    ],
  ...
  },
  {
    ...
    "parameters": [
      {
        "name": "input",
        "description": "The input string to append a checksum to.",
        "type": "unknown",
        "optional": false
      },
      {
    ...
    "returns": {
      "type": "string",
      "description": "The input string with appended checksum, or undefined if input is not a string."
    },
    "insertText": "withChecksum(${1:input}, ${2:chars}, ${3:sep})"
  },
  {
    "type": "transform",
    "name": "absoluteValue",
  ...
  },
  {
    ...
    "insertText": "formatDate(${1:format})",
    "aliases": [
      "dateFormat"
    ]
  },
  ...
  },
  {
    ...
    "insertText": "localTimeToIsoWithOffset(${1:timeZone})"
  },
  {
    "type": "transform",
    "name": "lowercase",
  ...
  },
  {
    ...
    "insertText": "verifyChecksum(${1:chars}, ${2:sep})"
  },
  {
    "type": "transform",
    "name": "withChecksum",
    ...
    "insertText": "withChecksum(${1:chars}, ${2:sep})"
  }
];
