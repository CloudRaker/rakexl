...
Rakexl provides built-in Monaco Editor support with syntax highlighting, IntelliSense completion, hover documentation, and error detection.

## Installation

```bash
npm install rakexl monaco-editor
```
