...
description: Using Rakexl in JavaScript and TypeScript projects
---

# JavaScript Implementation

Rakexl is the original JavaScript/TypeScript implementation with full type support and Monaco Editor integration.
...
```typescript
import jexl from 'rakexl';
import type { JexlExpression, Context } from 'rakexl';
...
- **Examples** - Check the [test files](https://github.com/konnektr-io/rakexl/tree/main/test) for more examples