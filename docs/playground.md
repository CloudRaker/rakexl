...
description: Complete guide to using the Rakexl interactive playground
---

# Rakexl Playground

The Rakexl Playground is an interactive web application that lets you experiment with JEXL expressions in real-time. Perfect for learning, testing, and prototyping.
...
- 💬 [GitHub Issues](https://github.com/rakerone/rakexl/issues) - Report bugs or ask questions
- 🌟 [GitHub Discussions](https://github.com/rakerone/rakexl/discussions) - Community support

Happy exploring! The playground is the perfect place to learn Rakexl and prototype your expressions before using them in your applications.